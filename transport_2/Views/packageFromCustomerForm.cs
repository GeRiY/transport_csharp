...
{
    public partial class packageFromCustomerForm : Form, IDataGridList<package>
    {
        
        private packageToGetFromCustomerPresenter presenter;
        // Oldaltördelés
        private int pageCount;
        private int sortIndex;

        public packageFromCustomerForm()
        {
            InitializeComponent();
            presenter = new packageToGetFromCustomerPresenter(this);
            Init();
        }
